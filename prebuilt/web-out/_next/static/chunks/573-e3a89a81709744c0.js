    ...
    4800: (e, r, o) => {
      ...
      let eb = ((e, ...r) => {
                  ...
                  (e) => {
                    ...
                    for (let l = 0; l < e.length; l++) {
                      let s = e[l],
                        ...
                        n = r.has(s);
                      a || n
                        ? (t.length > 0 && (t.sort(), o.push(...t), (t = [])), o.push(s))
                        : t.push(s);
                    }
        ...
        let e = x('color'),
          ...
          ea = () => [W, 'screen', 'full', 'dvw', 'lvw', 'svw', 'min', 'max', 'fit', ...G()],
          en = () => [W, 'screen', 'full', 'lh', 'dvh', 'lvh', 'svh', 'min', 'max', 'fit', ...G()],
          ei = () => [e, U, Q],
        ...
        return {
          ...
          classGroups: {
            ...
            'max-w': [{ 'max-w': [n, 'screen', 'none', 'prose', { screen: [a] }, ...es()] }],
            h: [{ h: ['screen', 'lh', ...es()] }],
            ...
            'text-decoration-thickness': [{ decoration: [I, 'from-font', 'auto', U, B] }],
            ...
            'bg-image': [
              {
                bg: [
                  'none',
                  {
                    linear: [{ to: ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, O, U, Q],
                    radial: ['', U, Q],
                    conic: [O, U, Q],
                  },
                  ee,
            ...
            transition: [
              { transition: ['', 'all', 'colors', 'opacity', 'shadow', 'transform', 'none', U, Q] },
            ],
            ...
            'will-change': [{ 'will-change': ['auto', 'scroll', 'contents', 'transform', U, Q] }],
            fill: [{ fill: ['none', ...ei()] }],
