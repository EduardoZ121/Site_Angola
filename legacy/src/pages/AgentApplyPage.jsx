...
export default function AgentApplyPage() {
  ...
  useEffect(() => {
    document.title = 'Seja agente | Kuteka'
  }, [])
  ...
  return (
    <main className="page-main agent-apply-page">
      <PageIntro
        eyebrow="Carreira Kuteka"
        title="Seja agente intermediário"
        subtitle="Apresente-se, envie CV opcional e complete o teste quando a administração convidar."
      />
      ...
      <div className="agent-page-body section-block-inner">
        ...
        <p className="agent-help-line">
          Precisa de conta Kuteka com email e telefone em{' '}
          <Link to="/conta">Minha conta</Link>.
          <HelpTip
            label="Ajuda: candidatura"
            text="A administração lê a apresentação, envia teste de 25 perguntas e activa o painel se passar."
          />
        </p>
            ...
            <form className="panel-card agent-apply-form" onSubmit={handleApply}>
              <label className="publish-field">
                ...
                <span className="publish-field-hint">
                  Mínimo 80 caracteres. O administrador lê isto antes do teste.
                </span>
              </label>
              ...
              <p className="agent-apply-meta">
                Perfil: {profile.name} • {profile.email} •{' '}
                {profile.phone || (
                  <Link to="/conta#dados">adicione telefone em Minha conta</Link>
                )}
              </p>
