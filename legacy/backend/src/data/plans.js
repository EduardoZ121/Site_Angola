/** Planos Kuteka — preços em Kwanza. Pagamentos Kz: integração pendente (não Stripe). */
...
export const SUPPORT_PLANS = [
  {
    id: 'apoio-publicacao',
    name: 'Apoio à publicação',
    priceKz: 50000,
    description: 'Equipa Kuteka recolhe dados, fotos e publica por si (/adicionar-propriedade).',
  },
]
...
export function getPlanById(planId) {
  return OWNER_PLANS.find((plan) => plan.id === planId) || null
}
