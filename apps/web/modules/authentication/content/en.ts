...
export const authCopyEn: AuthCopy = {
  ...
  common: {
    ...
    mailDeliveryFailed:
      'We could not send the confirmation email right now. The account may not have been created — try again later or use another email.',
    showPassword: 'Show',
    hidePassword: 'Hide',
  },
  emailOtp: {
  ...
  register: {
    ...
    subtitle: 'Public Beta: start in minutes. One account, your roles, your Kuteka space.',
    email: {
      label: 'Email',
    ...
    submitFailed: 'We could not create the account.',
  ...
  verify: {
    ...
    resendPartialSuccess:
      'Test code generated, but the confirmation email was not sent. Check SMTP configuration or try again later.',
  ...
  app: {
    ...
    betaWelcomeTitle: 'Welcome to the public Beta',
    betaWelcomeBody:
      'Explore, report issues, and help improve Kuteka. Authenticated feedback reaches the Beta Panel (KOCC).',
    betaWelcomeCta: 'Send feedback',
    emailLabel: 'Email',
