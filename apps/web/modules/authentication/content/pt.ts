...
export const authCopyPt = {
  ...
  common: {
    ...
    mailDeliveryFailed:
      'Não foi possível enviar o email de confirmação neste momento. A conta pode não ter sido criada — tente novamente mais tarde ou use outro email.',
  ...
  register: {
    title: 'Criar conta',
    subtitle: 'Beta pública: comece em minutos. Uma conta, os seus papéis, o seu espaço Kuteka.',
    email: {
      label: 'Email',
    ...
    submitFailed: 'Não foi possível criar a conta.',
  ...
  verify: {
    ...
    resendPartialSuccess:
      'Código de teste gerado, mas o email de confirmação não foi enviado. Verifique a configuração SMTP ou tente mais tarde.',
  ...
  app: {
    ...
    betaWelcomeTitle: 'Bem-vindo à Beta pública',
    betaWelcomeBody:
      'Explore, reporte problemas e ajude a melhorar a Kuteka. O feedback autenticado chega ao Painel Beta (KOCC).',
