...
export function ContractsHubClient() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4" aria-label="Resumo Contratos">
        {(
          [
            ['Activo', stats.active],
          ...
          <div key={label} className="rounded-kuteka border border-slate-200 bg-white px-4 py-3">
