...
export const shellCopyEs: ShellCopy = {
  ...
  notificationsMarkRead: 'Marcar todas como leídas',
  notificationsViewAll: 'Ver todas',
  notificationsArchive: 'Archivar',
  notificationsOpen: 'Actuales',
  notificationsUnread: 'No leídas',
  notificationsRead: 'Leídas',
  notificationsAction: 'Acción pendiente',
  notificationsArchived: 'Archivadas',
  language: 'Idioma',
  ...
  items: {
    ...
    contratos: 'Contratos',
    relatorios: 'Cartera de inmuebles',
    conta: 'Cuenta',
    admin: 'Administración',
    super: 'Super Admin',
    financeiro: 'Finanzas',
    ...
    serPrestador: 'Registrar empresa',
    planos: 'Planes Socio',
    fundador: 'Founder Center',
    escalacoes: 'Escalaciones',
    contabilista: 'Contable',
  ...
  betaFeedback: {
    ...
    title: 'Compartir feedback Beta',
    subtitle:
      'Ayude a mejorar Kuteka antes del lanzamiento comercial. El Super Admin lo ve en el Panel Beta.',
    kindFeedback: 'Sugerencia / feedback',
    kindBug: 'Reportar un error',
    kindReview: 'Evaluación de la experiencia',
    kindComplaint: 'Reclamación (persona, servicio o inmueble)',
    bodyLabel: 'Descripción',
    placeholder: 'Qué funcionó, qué falló o qué le gustaría ver…',
    submit: 'Enviar',
    sending: 'Enviando…',
    ...
    complaintBody:
      'Esto no es una sugerencia de producto. Use esta sección solo para un problema con una persona, un prestador, un socio, un agente, un inmueble o un servicio. La sugerencia y el error quedan en el formulario de arriba.',
    complaintAdminCta: 'Cola de escalaciones (ops)',
  },
  firstActions: {
    title: 'Su primera acción útil',
    kaiHint: 'KAI indica el siguiente paso correcto para su rol activo.',
    clientExplore: 'Explorar vivienda',
    clientTrust: 'Completar identidad (KIS)',
    partnerActivate: 'Activar patrimonio',
    partnerInventory: 'Ver inventario en Vivienda',
    agentPipeline: 'Abrir pipeline del Agente',
    adminPanel: 'Abrir Administración',
    dualClient: 'Explorar como Cliente',
    dualPartner: 'Publicar como Socio',
  },
};
