...
export const shellCopyFr: ShellCopy = {
  ...
  notificationsOpen: 'Actuelles',
  notificationsUnread: 'Non lues',
  notificationsRead: 'Lues',
  notificationsAction: 'Action en attente',
  notificationsArchived: 'Archivées',
  language: 'Langue',
  ...
  items: {
    ...
    contratos: 'Contrats',
    relatorios: 'Portefeuille de biens',
    conta: 'Compte',
    admin: 'Administration',
    super: 'Super Admin',
    financeiro: 'Finance',
    ...
    serPrestador: 'Enregistrer l’entreprise',
  ...
  betaFeedback: {
    ...
    kindReview: 'Avis sur l’expérience',
    kindComplaint: 'Réclamation (personne, service ou bien)',
    ...
    complaintBody:
      'Ce n’est pas une suggestion de produit. Utilisez cette section seulement pour un problème avec une personne, un prestataire, un partenaire, un agent, un bien ou un service. La suggestion et le bug restent dans le formulaire du dessus.',
