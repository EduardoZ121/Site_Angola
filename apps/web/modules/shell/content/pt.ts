...
export const shellCopyPt = {
  ...
  notificationsMarkRead: 'Marcar todas como lidas',
  notificationsViewAll: 'Ver todas',
  notificationsArchive: 'Arquivar',
  notificationsOpen: 'Actuais',
  notificationsUnread: 'Não lidas',
  notificationsRead: 'Lidas',
  notificationsAction: 'Acção pendente',
  notificationsArchived: 'Arquivadas',
  language: 'Idioma',
  ...
  items: {
    ...
    contratos: 'Contratos',
    relatorios: 'Carteira de patrimónios',
    conta: 'Conta',
    admin: 'Administração',
    super: 'Super Admin',
  ...
  betaFeedback: {
    ...
    kindBug: 'Reportar erro',
    kindReview: 'Avaliação da experiência',
    kindComplaint: 'Reclamação (pessoa, serviço ou património)',
    bodyLabel: 'Descrição',
    ...
    complaintBody:
      'Isto não é uma sugestão de produto. Use o formulário desta secção só para um problema com uma pessoa, um prestador, um parceiro, um agente, um património ou um serviço. A sugestão e o erro ficam no formulário de cima.',
