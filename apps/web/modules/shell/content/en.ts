...
export const shellCopyEn: ShellCopy = {
  ...
  notificationsOpen: 'Current',
  notificationsUnread: 'Unread',
  notificationsRead: 'Read',
  notificationsAction: 'Action needed',
  ...
  userMenu: {
    ...
    contactHint: 'Email and public documentation',
    logout: 'Sign out',
  },
  settingsPage: {
    title: 'Settings',
  ...
  helpPage: {
    ...
    subtitle: 'Manual, FAQ, glossary, news and service status — all in one place.',
    manual: 'User manual',
    faq: 'FAQ',
    glossario: 'Glossary',
  ...
  contactPage: {
    ...
    subtitle: 'Email us or browse the public documentation.',
    whatsapp: 'WhatsApp',
    phone: 'Phone',
    email: 'Email',
    chat: 'Chat',
  ...
  betaFeedback: {
    ...
    kindReview: 'Experience review',
    kindComplaint: 'Complaint (person, service or property)',
    ...
    complaintBody:
      'This is not a product suggestion. Use this section only for a problem with a person, provider, partner, agent, property or service. Suggestions and bugs stay in the form above.',
