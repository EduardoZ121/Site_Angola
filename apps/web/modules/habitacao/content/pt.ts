export const habitacaoCopyPt = {
  ...
  exploreSubtitle: 'Patrimónios activos — incluindo inventário Beta Kuteka.',
  emptyTitle: 'Sem resultados nesta exploração',
  empty: 'Ajuste filtros ou pesquisa. O inventário Beta Kuteka deve aparecer sem filtros.',
  emptyCta: 'Limpar filtros',
  captureDemandCta: 'Registar procura (Encontrar Casa)',
  ...
  photoAriaTemplate: 'Fotografia: {title}',
  detail: {
    inactiveHint: 'Este anúncio pode já não estar activo.',
    prepareContract: 'Preparar contrato',
    nextTitle: 'Continuar o percurso',
    stepAgent: 'Agente acompanha',
    stepContract: 'Preparar contrato',
    stepTrust: 'Confiança verifica',
    stepMore: 'Mais patrimónios',
    stepExplore: 'Explorar inventário',
  },
