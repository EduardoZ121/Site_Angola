...
| **KUT-FIN-009** | **Refund Policy** _(novo)_                                       | Doc 1 (ex-FIN-004)           | Procedimento financeiro de reembolso                |
| **KUT-FIN-010** | **Payment Responsibility Matrix** _(novo)_                       | Doc 1 (ex-FIN-002)           | Responsabilidades de pagamento                      |
