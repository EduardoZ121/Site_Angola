...
**Não** declarar sucesso só por:

- "10.000 utilizadores" sem activação
- Volume sem conclusão de fluxos
- Registos sem património/procura/feedback

## Critério saída Beta → v1.1 (BETA-35)

Gerar relatório evidências:

- TOP 10 BUGS
- TOP 10 UX
- TOP 10 PEDIDOS
- TOP 10 funcionalidades mais/menos usadas
- TOP zonas procuradas
- TOP serviços/categorias prestadores

## Cadência revisão

- Semanal: Founder + Super (KOCC)
- Mensal: scorecard completo + decisão backlog v1.1
