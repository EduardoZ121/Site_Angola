...
**Versão:** 1.0  
**Estado:** Activo (PRD-001 **spec v0.4** em revisão · Bloco 1 ✅ · Bloco 2 fluxos ▶️ · implementação **não** autorizada)  
...
2 Autenticação (PRD-001) — spec v0.3 (Bloco 1 fechado); implementar só após aprovação integral + CI + migration `0002`  
