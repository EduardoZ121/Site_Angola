...
**Versão:** 1.0  
**Estado:** Activo (PRD-001 **spec v1.0-rc3** em revisão · Blocos 1–2 ✅ · Bloco 3 auto-revisão crítica · implementação **não** autorizada)  
...
**Papel do agente (desde 2026-07-30):** Arquitecto Principal e Guardião da Consistência — auto-revisão obrigatória contra documentos oficiais antes de apresentar qualquer proposta; intervenção do PO só em decisões de negócio / conflitos / escolhas estratégicas. Ao fechar cada bloco importante: secção **Autoavaliação do Arquitecto** (confiança %, riscos, dívidas, adiados, recomendação Aprovar / Aprovar com reservas / Não aprovar) — ver `DEVELOPMENT_PROCESS.md`.
...
2 Autenticação (PRD-001) — spec v1.0-rc3 (Blocos 1–2 ✅ · Bloco 3 em auto-revisão final); implementar só após aprovação integral + CI + migration `0002`  
