...
**Versão:** 1.0  
**Estado:** Activo (PRD-001 **spec v0.6** em revisão · Bloco 1 ✅ · Bloco 2 F1✅ F2✅ F3▶️ · implementação **não** autorizada)  
...
2 Autenticação (PRD-001) — spec v0.6 (Bloco 2 fluxos em revisão); implementar só após aprovação integral + CI + migration `0002`  
