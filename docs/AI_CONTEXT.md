...
**Versão:** 1.0  
**Estado:** Activo (PRD-001 **spec v0.7** em revisão · Bloco 1 ✅ · Bloco 2 F1✅ F2✅ F3✅ F4▶️ · implementação **não** autorizada)  
...
2 Autenticação (PRD-001) — spec v0.7 (Bloco 2 fluxos em revisão); implementar só após aprovação integral + CI + migration `0002`  
