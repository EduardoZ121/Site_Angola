...
import { AddPropertyCrossNav } from '../components/publish/AddPropertyCrossNav'
import { AddPropertyProgress } from '../components/publish/AddPropertyProgress'
...
export default function AddPropertyDetailsPage() {
  ...
  useEffect(() => {
    document.title = submitted ? 'Pedido recebido | Kuteka' : 'Detalhes da propriedade | Kuteka'
  }, [submitted])
  ...
  if (submitted) {
    return (
      <main className="page-main add-property-page">
        <div className="section-block-inner">
          <CatalogBreadcrumbs
            items={[
              { label: 'Início', to: '/inicio' },
              { label: 'Adicionar propriedade', to: '/adicionar-propriedade' },
              { label: 'Pedido enviado', to: '/adicionar-propriedade/detalhes' },
            ]}
          />
      ...
      <div className="section-block-inner">
        <CatalogBreadcrumbs
          items={[
            { label: 'Início', to: '/inicio' },
            { label: 'Adicionar propriedade', to: '/adicionar-propriedade' },
            { label: 'Detalhes', to: '/adicionar-propriedade/detalhes' },
          ]}
        />

        <p className="publish-help-line">
          Os campos com * são obrigatórios. Dados guardados só neste dispositivo (demo).
          <HelpTip
            label="Ajuda: privacidade"
            text="Em produção os dados seriam enviados de forma segura. Consulte a política de privacidade Kuteka."
          />
        </p>

        <AddPropertyProgress step={2} />
        <AddPropertyCrossNav />
        ...
        <SectionBlock id="detalhes" eyebrow="Imóvel" title="Estado e planos">
          <form className="owner-form panel-card add-property-details-form" onSubmit={handleSubmit}>
            ...
            <label className="checkbox-line">
              ...
              />
              Confirmo que os dados são verdadeiros e aceito a{' '}
              <Link to="/sobre#privacidade">política de privacidade</Link> Kuteka.
            </label>
