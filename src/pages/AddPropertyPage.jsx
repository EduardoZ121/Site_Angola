...
export default function AddPropertyPage() {
  ...
  useEffect(() => {
    document.title = 'Adicionar propriedade | Kuteka'
  }, [])
    ...
    <main className="page-main add-property-page">
      ...
      <div className="section-block-inner">
        ...
        <p className="publish-help-line">
          Prefere publicar sozinho?{' '}
          <Link to="/publicar">Use o assistente de publicação</Link>.
          <HelpTip
            label="Ajuda: adicionar propriedade"
            text="Este formulário pede apoio da equipa Kuteka. Para publicar directamente, use /publicar com fotos e preço."
          />
        </p>

        <AddPropertyProgress step={1} />
        <AddPropertyCrossNav />

        <SectionBlock id="endereco" eyebrow="Localização" title="Onde fica a propriedade?" tone="muted">
              ...
              <div className="property-type-grid">
                {propertyTypes.map((type) => (
                  <button
                    ...
                    type="button"
                    className={
                      draft.propertyType === type.value ? 'property-type-chip active' : 'property-type-chip'
                    }
